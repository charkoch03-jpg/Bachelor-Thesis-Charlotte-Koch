...
for b in range(n_blocks):
    ...
    for trial in range(n_trials):
        ...
        # average both eyes for this trial
        trial_data_L = pupilL[b, trial, :].astype(float)
        trial_data_R = pupilR[b, trial, :].astype(float)
        trial_data = (trial_data_L + trial_data_R) / 2  # average across eyes
