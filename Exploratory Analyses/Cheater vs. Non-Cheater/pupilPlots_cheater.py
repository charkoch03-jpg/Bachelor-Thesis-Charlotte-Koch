...
cheater_mask = (cheater == 1)  # True for cheater trials
...
finish_plot("Average Pupil Size over Time for Cheaters by Current Valence")
...
finish_plot("Average Pupil Size over Time for Cheaters by Previous Valence)")
...
finish_plot("Average Pupil Size over Time for Cheaters by Task Condition")
